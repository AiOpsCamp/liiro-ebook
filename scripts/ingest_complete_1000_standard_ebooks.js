...
async function runIngestion() {
  ...
  let mongoUrl =
    ...
    process.env.LANGOREADS_MONGO_URL_PROD ||
    process.env.MONGO_URL_PROD ||
    process.env.MONGO_URL ||
    process.env.DATABASE_URL;

  if (!mongoUrl) {
    mongoUrl = "mongodb://admin:PROD_PASSWORD_2026@mongodb-svc.multicamp.svc.cluster.local:27017/langoread_prod?authSource=admin";
  }

  console.log("=========================================================================");
  console.log(`🚀 INGESTING & SYNCHRONIZING UP TO ${maxBooksToProcess} STANDARD EBOOKS`);
  console.log(`🔗 Target Database: ${mongoUrl.replace(/:[^:@]+@/, ":***@")}`);
  console.log("=========================================================================\n");
